...
Для сборки компоненты под Windows использовалась Visual Studio 2022 Community Edition.
...
### Планы по развитию
- Добавить версию под архитектуру e2k;
- Протестировать версию под архитектурой ARM64;
- Добавить метод для отправки произвольного символа на устройство.
